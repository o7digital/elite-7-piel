...
export default function Footer16() {
  return (
    <footer className="footer footer_type_2 border-top">
      <div className="footer-top container">
        <div className="block-newsletter">
          <h3 className="block__title fs-35 fw-bold text-uppercase mb-2">
          ...
          >
            ...
            />
            <button
              className="btn btn-secondary fw-semi-bold theme-bg-color-secondary border-0"
              type="submit"
            >
              JOIN
            </button>
      ...
      <div className="footer-middle container">
        <div className="row row-cols-lg-5 row-cols-2">
          ...
          <div className="footer-column footer-menu mb-4 mb-lg-0">
            <h6 className="sub-menu__title text-uppercase fs-22 fw-bold">
              Company
            </h6>
          ...
          <div className="footer-column mb-4 mb-lg-0">
            ...
            <ul className="list-unstyled">
              <li>
                <span className="menu-link fs-13">Mon - Fri: 8AM - 9PM</span>
              </li>
              <li>
                <span className="menu-link fs-13">Sat: 9AM - 8PM</span>
              </li>
              <li>
                <span className="menu-link fs-13">Sun: Closed</span>
              </li>
            </ul>
          </div>
          {/* <!-- /.footer-column --> */}
